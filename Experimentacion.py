...
# Cancion
artista = Artist(token, "The Beatles")

print(artista.get_songs_artist())
for i, song in enumerate(artista.get_songs_artist()):
    print(f"\t{i + 1}.")
    print(f"\t{i + 1}. {song['album']['name']}") 
    print(f"\t{i + 1}. {song['name']}") 
    print(f"\t{i + 1}. {song['track_number']}") 
    print(f"\t{i + 1}. {song['duration_ms']}") 
